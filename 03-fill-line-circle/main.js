...
//种子填充，我知道，有泄漏的风险
function seedFill(x,y,r1,g1,b1,a1){
    setPixel(x,y,r1,g1,b1,a1);
    
    if(!testSeed(x+1,y,r1,g1,b1,a1)){
        seedFill(x+1,y,r1,g1,b1,a1);
    }
    
    if(!testSeed(x,y+1,r1,g1,b1,a1)){
        seedFill(x,y+1,r1,g1,b1,a1);
    }
